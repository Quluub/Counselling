...
const Login = () => (
  ...
  >
    ...
    <div className="card p-1" style={{ maxWidth: '400px', width: '100%', border:'none' }}>
      ...
      <p style={{fontSize:'15px'}} className="text-center text-muted mb-4">Welcome back. Find peace and guidance.</p>
      <form>
        <div className="mb-3">
          <input
            type="email"
            className="form-control input-teal text-white"
        ...
        <div className="d-flex justify-content-between align-items-center mb-3">
          <div>
          <small className="form-text text-danger">Dont have an account yet?</small>

<Link to="/client/sign-up" style={{width:'200px', height:'40px', borderRadius:'8px'}} className="btn btn-outline-secondary btn-sm me-3">Signup</Link>
          </div>
        
          <button type="submit" style={{width:'200px', height:'40px', borderRadius:'8px'}} className="btn btn-teal mt-3  "> Login</button>
