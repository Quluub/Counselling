          ...
          <p className="mb-2" style={{  fontSize: "20px",  fontStyle:'italic' , marginBottom:'10px' }}>
            ...
            <div className="mb-3 mt-1">
              ...
              <div className="mb-1 mt-2">
               ...
               <span className="text-bold"> <b>3.  </b> </span> <span className="mx-2 font-weight-bold" style={{ textDecoration: "underline" , fontWeight:'bold'}}>    Country of Residence </span>
              </div>
    ...
    >
      ...
      >
          <div className="d-flex justify-content-between align-items-center mb-3">
                  <button type="submit" style={{width:'200px', height:'40px', borderRadius:'8px'}} className="btn text-black btn-outline-secondary btn-sm me-3"><a style={{ color: 'black', textDecoration: 'none' }} href="/client/nationality"> Previous</a> </button>
                  <button type="submit" style={{width:'200px', height:'40px', borderRadius:'8px'}} className="btn btn-teal  "> <a style={{ color: 'white', textDecoration: 'none' }} href="/client/city">Next</a></button>
